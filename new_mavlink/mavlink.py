...
Generated from: ('custom_message.xml',)
...
MAVLINK_MSG_ID_MY_CUSTOM_COMMAND = 180
MAVLINK_MSG_ID_ANOTHER_CUSTOM_COMMAND = 181


class MAVLink_my_custom_command_message(MAVLink_message):
    """
    My custom MAVLink command
    """

    id = MAVLINK_MSG_ID_MY_CUSTOM_COMMAND
    msgname = "MY_CUSTOM_COMMAND"
    fieldnames = ["target_system", "target_component", "param1", "param2", "param3", "param4", "param5", "param6", "param7"]
    ordered_fieldnames = ["param2", "param3", "param4", "param5", "param6", "param7", "target_system", "target_component", "param1"]
    fieldtypes = ["uint8_t", "uint8_t", "char", "float", "float", "float", "float", "float", "float"]
    fielddisplays_by_name: Dict[str, str] = {}
    fieldenums_by_name: Dict[str, str] = {}
    fieldunits_by_name: Dict[str, str] = {}
    native_format = bytearray(b"<ffffffBBc")
    orders = [6, 7, 8, 0, 1, 2, 3, 4, 5]
    lengths = [1, 1, 1, 1, 1, 1, 1, 1, 1]
    array_lengths = [0, 0, 0, 0, 0, 0, 0, 0, 50]
    crc_extra = 44
    unpacker = struct.Struct("<ffffffBB50s")
    instance_field = None
    instance_offset = -1

    def __init__(self, target_system: int, target_component: int, param1: bytes, param2: float, param3: float, param4: float, param5: float, param6: float, param7: float):
        MAVLink_message.__init__(self, MAVLink_my_custom_command_message.id, MAVLink_my_custom_command_message.msgname)
        self._fieldnames = MAVLink_my_custom_command_message.fieldnames
        self._instance_field = MAVLink_my_custom_command_message.instance_field
        self._instance_offset = MAVLink_my_custom_command_message.instance_offset
        self.target_system = target_system
        self.target_component = target_component
        self._param1_raw = param1
        self.param1 = param1.split(b"\x00", 1)[0].decode("ascii", errors="replace")
        self.param2 = param2
        self.param3 = param3
        self.param4 = param4
        self.param5 = param5
    ...
    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(mav, self.crc_extra, self.unpacker.pack(self.param2, self.param3, self.param4, self.param5, self.param6, self.param7, self.target_system, self.target_component, self._param1_raw), force_mavlink1=force_mavlink1)


# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_my_custom_command_message, "name", mavlink_msg_deprecated_name_property())


class MAVLink_another_custom_command_message(MAVLink_message):
    """
    Another custom MAVLink command
    """

    id = MAVLINK_MSG_ID_ANOTHER_CUSTOM_COMMAND
    msgname = "ANOTHER_CUSTOM_COMMAND"
    fieldnames = ["target_system", "target_component", "param1", "param2", "param3", "param4"]
    ordered_fieldnames = ["param1", "param2", "param3", "param4", "target_system", "target_component"]
    fieldtypes = ["uint8_t", "uint8_t", "float", "float", "float", "float"]
    fielddisplays_by_name: Dict[str, str] = {}
    fieldenums_by_name: Dict[str, str] = {}
    fieldunits_by_name: Dict[str, str] = {}
    native_format = bytearray(b"<ffffBB")
    orders = [4, 5, 0, 1, 2, 3]
    lengths = [1, 1, 1, 1, 1, 1]
    ...
    def __init__(self, target_system: int, target_component: int, param1: float, param2: float, param3: float, param4: float):
        MAVLink_message.__init__(self, MAVLink_another_custom_command_message.id, MAVLink_another_custom_command_message.msgname)
        self._fieldnames = MAVLink_another_custom_command_message.fieldnames
        self._instance_field = MAVLink_another_custom_command_message.instance_field
        self._instance_offset = MAVLink_another_custom_command_message.instance_offset
        self.target_system = target_system
        self.target_component = target_component
        self.param1 = param1
        self.param2 = param2
    ...
    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(mav, self.crc_extra, self.unpacker.pack(self.param1, self.param2, self.param3, self.param4, self.target_system, self.target_component), force_mavlink1=force_mavlink1)


# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_another_custom_command_message, "name", mavlink_msg_deprecated_name_property())


mavlink_map: Dict[int, Type[MAVLink_message]] = {
    MAVLINK_MSG_ID_MY_CUSTOM_COMMAND: MAVLink_my_custom_command_message,
    MAVLINK_MSG_ID_ANOTHER_CUSTOM_COMMAND: MAVLink_another_custom_command_message,
}
...
class MAVLink(object):
    ...
    def my_custom_command_encode(self, target_system: int, target_component: int, param1: bytes, param2: float, param3: float, param4: float, param5: float, param6: float, param7: float) -> MAVLink_my_custom_command_message:
        """
        My custom MAVLink command

        target_system             : System ID (type:uint8_t)
        target_component          : Component ID (type:uint8_t)
        param1                    : Parameter 1 (type:char)
        param2                    : Parameter 2 (type:float)
        param3                    : Parameter 3 (type:float)
        param4                    : Parameter 4 (type:float)
        param5                    : Parameter 5 (type:float)
        param6                    : Parameter 6 (type:float)
        param7                    : Parameter 7 (type:float)

        """
        return MAVLink_my_custom_command_message(target_system, target_component, param1, param2, param3, param4, param5, param6, param7)

    def my_custom_command_send(self, target_system: int, target_component: int, param1: bytes, param2: float, param3: float, param4: float, param5: float, param6: float, param7: float, force_mavlink1: bool = False) -> None:
        """
        My custom MAVLink command
        ...
        """
        self.send(self.my_custom_command_encode(target_system, target_component, param1, param2, param3, param4, param5, param6, param7), force_mavlink1=force_mavlink1)

    def another_custom_command_encode(self, target_system: int, target_component: int, param1: float, param2: float, param3: float, param4: float) -> MAVLink_another_custom_command_message:
        """
        Another custom MAVLink command

        target_system             : System ID (type:uint8_t)
        target_component          : Component ID (type:uint8_t)
        param1                    : Parameter 1 (type:float)
        param2                    : Parameter 2 (type:float)
        param3                    : Parameter 2 (type:float)
        param4                    : Parameter 2 (type:float)

        """
        return MAVLink_another_custom_command_message(target_system, target_component, param1, param2, param3, param4)

    def another_custom_command_send(self, target_system: int, target_component: int, param1: float, param2: float, param3: float, param4: float, force_mavlink1: bool = False) -> None:
        """
        Another custom MAVLink command
        ...
        """
        self.send(self.another_custom_command_encode(target_system, target_component, param1, param2, param3, param4), force_mavlink1=force_mavlink1)
